...
public:
	...
	~Surface();
	// member data access
	inline Pixel* GetBuffer() { return m_Buffer; }
	inline void SetBuffer( Pixel* a_Buffer ) { m_Buffer = a_Buffer; }
	inline int GetWidth() { return m_Width; }
	inline int GetHeight() { return m_Height; }
	inline int GetPitch() { return m_Pitch; }
	inline void SetPitch( int a_Pitch ) { m_Pitch = a_Pitch; }
	...
	void DumpTo(Surface* a_Destination);
	int SaveToTGA(const char* a_File);
