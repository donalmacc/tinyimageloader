...
Internal method.
\end{DoxyNote}
An implementation of printf for errors. The parameters in a\_\-Message are parsed and sent to the attached logging function. This can be the internal logger or one of your own. \hypertarget{namespacetil_af5e790af48ce0da5bd73f41830705e1a}{
\index{til@{til}!AlphaBlend\_\-16b\_\-B5G6R5@{AlphaBlend\_\-16b\_\-B5G6R5}}
\index{AlphaBlend\_\-16b\_\-B5G6R5@{AlphaBlend\_\-16b\_\-B5G6R5}!til@{til}}
\subsubsection[{AlphaBlend\_\-16b\_\-B5G6R5}]{\setlength{\rightskip}{0pt plus 5cm}{\bf color\_\-16b} til::AlphaBlend\_\-16b\_\-B5G6R5 (
\begin{DoxyParamCaption}
\item[{uint8}]{a\_\-Red, }
...
\label{namespacetil_af5e790af48ce0da5bd73f41830705e1a}
...
16-\/bit BGR color
\end{DoxyReturn}
Blends the RGB values with the alpha value. \hypertarget{namespacetil_aa272abfc1060298455205cfe08c95e37}{
...
/code MyStream$\ast$ stream = new MyStream(); stream-\/$>$Open(\char`\"{}MyFile.png\char`\"{}, TIL\_\-ADDWORKINGDIR); \hyperlink{classtil_1_1_image}{til::Image}$\ast$ load = til::TIL\_\-Load(stream, TIL\_\-DEPTH\_\-A8B8G8R8); /endcode \hypertarget{namespacetil_a4e9b5c8b33ec4ec38e7ef895a8eac58e}{
